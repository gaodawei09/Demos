	...
	<body ondblclick="fullScreen()">
		...
		<script type="text/javascript">
			...
			function openChannel() {
				...
				socket = new WebSocket("ws://10.111.42.217:8080/WebRTC/acgist.video/${requestScope.uid}");
			...
			function noticeMsg() {
				if (!initiator) {
					setNotice("让别人加入（注意事项查看源码）: http://10.111.42.217:8080/WebRTC/msg?oid=${requestScope.uid }");
				} else {
					setNotice("初始化...");
				}
			}
